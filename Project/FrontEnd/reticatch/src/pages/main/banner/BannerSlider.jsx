...
const Slider = () => {
  ...
  const slides = [
    { src: "../src/pages/main/images/241209030423_16007528.jpeg", link: "http://example.com/page1" },
    { src: "src/pages/main/images/241205021648_24016695.jpeg", link: "http://example.com/page2" },
    { src: "src/pages/main/images/241205011108_16007528.png", link: "http://example.com/page3" },
    { src: "src/pages/main/images/241016043016_16007528.png", link: "http://example.com/page4" },
    { src: "src/pages/main/images/241128031052_16007528.png", link: "http://example.com/page5" },
    { src: "src/pages/main/images/241125051028_24016737.png", link: "http://example.com/page1" },
    { src: "src/pages/main/images/240816042019_24011935.jpeg", link: "http://example.com/page2" },
    { src: "src/pages/main/images/241008024945_24014511.png", link: "http://example.com/page3" },
    { src: "src/pages/main/images/241107041700_24015649.jpeg", link: "http://example.com/page4" },
    { src: "src/pages/main/images/240904095711_24012498.png", link: "http://example.com/page5" }
  ];
